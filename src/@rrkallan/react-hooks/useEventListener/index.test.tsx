...
describe("useEventListener()", () => {
    ...
    it("should bind/unbind the event listener to the window when element is not provided", () => {
        ...
        expect(windowRemoveEventListenerSpy).toHaveBeenCalledWith(eventName, expect.any(Function));
    });
    ...
    it("should bind/unbind the event listener to the element when element is provided", () => {
        ...
        expect(refRemoveEventListenerSpy).toHaveBeenCalledWith(eventName, expect.any(Function));
    });
    ...
    it("should bind/unbind the event listener to the document when document is provided", () => {
        ...
        expect(docRemoveEventListenerSpy).toHaveBeenCalledWith(eventName, expect.any(Function));
    });
